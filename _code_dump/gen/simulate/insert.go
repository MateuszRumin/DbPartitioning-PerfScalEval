...
func ChooseTableInsert(idb []int, idc []int, idph []int, idp []int, idu []int) string {
...
func insertTest(deadline time.Time, idb []int, idc []int, idph []int, idp []int, idu []int) {
	// if id > 10 && id < 21 {
	...
	for time.Now().Before(deadline) {
		...
		query := ChooseTableInsert(idb, idc, idph, idp, idu)
